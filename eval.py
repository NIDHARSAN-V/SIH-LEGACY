...
def evaluate_answer(reference_answer, candidate_answer, question):
    ...
    if question_type == "explanation":
        sbert_score, ref_keywords, cand_keywords, question_keywords, ref_original, cand_original, question_original = evaluate_with_sbert(reference_answer, candidate_answer, question)
        keyword_score, _, _, _, _, _, _ = evaluate_with_keywords(reference_answer, candidate_answer, question)
    else:
        keyword_score, ref_keywords, cand_keywords, question_keywords, ref_original, cand_original, question_original = evaluate_with_keywords(reference_answer, candidate_answer, question)
        sbert_score, _, _, _, _, _, _ = evaluate_with_sbert(reference_answer, candidate_answer, question)

    generalized_score = generalize_score(sbert_score, keyword_score, question_original, ref_original, cand_original)
